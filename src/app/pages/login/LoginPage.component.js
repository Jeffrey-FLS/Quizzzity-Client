        ...
        return (
            <div className="loginPage">
                <header className="login_-_header_--_loginPage">
                    <h1>Quizzzity</h1></header>

                <div className="container">
                    <div className="row">

                        <div
                            className="login col-12 col-sm-8 col-md-6 col-lg-5">
                            <div className="login_-_body">
                                ...
                                <form action="" className="login_-_form">
                                    <label
                                        htmlFor="username"><FaUserAlt/></label>
                                    ...
                                    <div
                                        className="login_-_form_--_remember-forgot">
                                        <label className="checkbox-container"
                                               htmlFor="remember">Remember
                                            <input type="checkbox"
                                                   name="remember"/>
                                    ...
                                    <div className="login_-_form_--_buttons">
                                        ...
                                        <div
                                            className="login_-_form_--_buttons--social-links">
